...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const richard: Character = new Character('richard', 'Richard', Alignment.lawfulEvil,
      'Wizard', 5, new AbilityScores(10, 14, 13, 18, 12, 10));
    ...
    const alton: Character = new Character('alton', 'Alton', Alignment.chaoticGood,
      'Bard', 5, new AbilityScores(8, 14, 14, 14, 10, 20));
